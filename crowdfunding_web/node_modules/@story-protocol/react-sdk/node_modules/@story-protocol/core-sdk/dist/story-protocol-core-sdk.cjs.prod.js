        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!(getAddress$1(royaltyPolicy, "request.royaltyPolicy") !== viem.zeroAddress)) {
                _context.next = 8;
                break;
              }
              _context.next = 5;
            ...
            case 8:
              if (!(getAddress$1(currency, "request.currency") !== viem.zeroAddress)) {
                _context.next = 14;
                break;
              }
              _context.next = 11;
      ...
      var _payRoyaltyOnBehalf = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              if (!(getAddress$1(payerIpId, "request.payerIpId") && payerIpId !== viem.zeroAddress)) {
                _context2.next = 13;
                break;
              }
              _context2.next = 10;
      ...
      var _createNFTCollection = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              if (!(request.mintFee !== undefined && (request.mintFee < 0n || !viem.isAddress(request.mintFeeToken || "")))) {
                _context.next = 3;
                break;
              }
