...
const ManageMfaWidgetView = () => {
    ...
    const backButton = dynamicWidgetView === 'manage-mfa' ? (jsxRuntime.jsx(IconButton.IconButton, { type: 'button', onClick: () => setDynamicWidgetView('account-and-security-settings'), "data-testid": 'back-button', children: jsxRuntime.jsx(chevronLeft.ReactComponent, {}) })) : undefined;
